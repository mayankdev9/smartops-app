...
// `tour` ids are targeted by the ProductTour component (app/(app)/dashboard/page.tsx).
const NAV: NavItem[] = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, tour: "nav-dashboard" },
  { href: "/alerts", label: "Alerts", icon: Bell, tour: "nav-alerts" },
  { href: "/onboarding", label: "Setup & Data", icon: Settings, tour: "nav-upload" },
  { href: "/assistant", label: "Assistant", icon: MessageSquare, tour: "nav-assistant" },
